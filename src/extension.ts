...
function remindAddToPath() {
    return vscode.window
        .showInformationMessage("Remember to add Processing to your path!", "Learn More")
...
function openDocErrorMessage(str: string) {
    return vscode.window
        .showErrorMessage("Error: " + str, "Open Docs")
        .then((item: string | undefined) => {
            if (item === "Open Docs") {
                search.openURL("docs")
            }
...
export function activate(context: vscode.ExtensionContext) {
    ...
    let open_documentation = vscode.commands.registerCommand(
